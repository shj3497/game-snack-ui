...
import DrawSecondIntro1x from '@/assets/event/draw-second/intro-bg@1x.webp';
import DrawSecondIntro2x from '@/assets/event/draw-second/intro-bg@2x.webp';
import DrawSecondIntro3x from '@/assets/event/draw-second/intro-bg@3x.webp';
...
import {IntroLoaderResponse} from '@/pages/event/draw-second/loader';
...
const bgSources: PictureProps['sources'] = {
  srcSet: {
    '1x': DrawSecondIntro1x,
    '2x': DrawSecondIntro2x,
  },
  type: 'image/webp',
};

const DrawSecondIntro: FC<Props> = ({loaderData}) => {
  ...
  return (
    <DrawSecondLayout>
      <Inner>
        ...
        <ButtonWrap>
          <Link to={paths.event.draw_second.participate} onClick={handleClick}>
            <GameButton
              sx={{
...
export default DrawSecondIntro;
