...
export type EventListResponseResultCode =
  (typeof EventListResponseResultCode)[keyof typeof EventListResponseResultCode];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const EventListResponseResultCode = {
