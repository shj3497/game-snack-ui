...
export type ApiErrorResponseResultCode =
  (typeof ApiErrorResponseResultCode)[keyof typeof ApiErrorResponseResultCode];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiErrorResponseResultCode = {
